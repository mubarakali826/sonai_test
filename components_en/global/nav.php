                    ...
                    <div class="dropdown language-switcher px-2">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                            <li class="dropdown-item w-100" data-lang="en">
                                <form class="w-100" action="<?= $currentPage ?>.php?<?= $parameter ?>" method="POST">
                        ...
                        <ul
                            ...
                            <?php foreach ($menus as $key => $menu): ?>
                                <li class="nav-item dropdown">
                                    ...
                                    <div class="ts-dropdown-menu dropdown-menu m-0 ts-dropdown-menu-<?= $key ?>">
                                        <ul class="list-unstyled">
                                            <?php foreach ($menu['items'] as $index => $item): ?>
                                                <li>
                                                    <a class="dropdown-item ts-dropdown-item-<?= $key ?> <?= $index === 0 ? 'ts-dropdown--active' : '' ?>"
                                                        data-image-set="<?= $key ?>"
                            ...
                            <li class="nav-item">
                                <a class="nav-link d-flex align-items-center gap-2 <?= $currentPage === 'contact' ? 'active' : '' ?>"
                                    href="./contact.php">
                                    <?= t('Contact Us', '联系我们') ?>
                                </a>
                            </li>
