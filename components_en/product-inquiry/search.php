    ...
    <div class="ts-product-title-list px-4 py-2">
        <div class="ts-container-fluid">
            <div class="row gap-2 gap-md-0">
                ...
                <div class="col-md-4">
                    <div>
                        <input type="text" class="form-control" placeholder="Search" name="product_id"
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.getElementById('search-form').addEventListener('submit', function(event) {
        ...
        // If "Select All" option is chosen, remove the cate_id and product_id from the URL and reload
