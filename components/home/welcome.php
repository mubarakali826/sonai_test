...
<section class="ts-applications mb-14 ">
    <header class="ts-header-container mb-14" data-aos="fade-down" data-aos-once="true">
        ...
        <div class="content">
            <h1 class="ts-fs-42"><span class="ts-text-primary">欢迎来到 </span>宇仕</h1>
            <p>专业生产刹车片</p>
        </div>
    </header>
                    ...
                    <div class="h-100">
                        <a class="ts-welcome-card text-decoration-none text-black mb-2 w-100 h-100">
                            ...
                            <div class="p-2 p-sm-4 ">
                                <h5 class="ts-fs-18 text-uppercase mb-3">新型材料</h5>
                                <p class="mb-0">耐高温、防水、安全性提高80%.
                            </div>
                        </a>
                    </div>
                </div>
                ...
                <div class="swiper-slide h-auto" data-aos="fade-up" data-aos-once="true">
                    <div class="h-100">
                        <a class="ts-welcome-card text-decoration-none text-black mb-2 w-100 h-100">
                            ...
                            <div class="p-2 p-sm-4 ">
                                <h5 class="ts-fs-18 text-uppercase mb-3">三重认证</h5>
                                <p class="mb-0">EMARK、SGS、ENAC等欧盟专业检测机构</p>
                            </div>
                        </a>
                    </div>
                </div>
                ...
                <div class="swiper-slide h-auto" data-aos="fade-up" data-aos-once="true">
                    <div class="h-100">
                        <a class="ts-welcome-card text-decoration-none text-black mb-2 w-100 h-100">
                            ...
                            <div class="p-2 p-sm-4 ">
                                <h5 class="ts-fs-18 text-uppercase mb-3">新版包装</h5>
                                <p class="mb-0">脱颖而出，最重要的是展示了对一流的承诺</p>
                            </div>
                        </a>
                    </div>
                </div>
