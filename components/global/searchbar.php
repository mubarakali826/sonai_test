...
<div class="ts-search-bar-secondary input-group">
    <form class="search-form d-flex justify-content-end gy-3" action="./search.php" method="GET">
        <input id="searchInput" type="text" class="form-control rounded-pill ps-5" placeholder="搜索" aria-label="Search"
            aria-describedby="button-addon2" name="search" value="<?php echo $search_keyword; ?>">
