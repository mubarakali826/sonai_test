...
<div class="shadow-sm pt-2 pb-3 ">
    <div class="ts-container-fluid">
        <h3 class="text-center text-black mb-0">搜索结果 : <?php echo $search_keyword; ?> </h3>
    </div>
</div>
...
<div class="ts-container-fluid my-5">
    ...
    <ul class="list-unstyled d-flex flex-column gap-3">
        <li class="d-flex justify-content-between">
            <h3 class="ts-search-result-item text-black mb-0">产品应用</h3>
            <h3 class="ts-search-result-item text-black mb-0">时间</h3>
        </li>
        <?php
            foreach ($pageRes as $row) {
                echo '
                <li class="d-flex justify-content-between ts-link-hover-primary">
                    <h3 class="ts-search-result-item mb-0"><a class="text-decoration-none ts-text-gray-4 " href="product-detail.php?id=' . $row['id'] . '&search_keyword=' . $row['productname'] . '">' . $row['productname'] . '</a></h3>
    ...
    <div class="text-center">
        <h3 class="text-black mb-0">未找到产品。</h3>
    </div>
    <?php } ?>
</div>